...
{%提示 style=&quot;info&quot; %}
**Chloros+ 速度**：处理大型数据集时，并行模式可比顺序模式快5-10倍。在免费模式下耗时2小时的500张图像项目，使用Chloros+仅需15-20分钟即可完成。
{% endhint %}
...
**规划建议：**对于超大型项目，建议分批处理或使用CLI实现更精细控制。
...
### 粗略估算（Chloros+模式，1200万像素图像，现代CPU）
...
| 500张图片  | 2-3小时   | 45-60分钟      | 20-30分钟      |
| 1000张图片 | 4-6小时   | 1.5-2小时      | 40-60分钟      |
...
1. **监控进度** - 参见[处理进度监控](monitoring-the-processing.md)
2. **等待完成** - 处理过程自动运行
3. **查看结果** - 参见[处理完成指南](finishing-the-processing.md)

处理期间的操作说明请参阅[处理过程监控](monitoring-the-processing.md)。

...
* **Adobe Photoshop** - 专业级编辑（支持TIFF格式）
* **GIMP** - Photoshop免费替代方案
* **Windows Photos** - 基础查看功能（可能不支持16位TIFF格式）
...
1. 在文件浏览器中点击图像缩略图
2. 图像将在主预览区域打开
3. 点击左侧边栏的**图像查看器** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> 标签页
...
1. **使用带LUT色彩的指数图像**制作可视化报告
2. **提取统计数据**：按田块/样方计算NDVI均值
3. **时间序列**：跨多次观测对比指数变化
...
* ✅ **原始RAW/JPG图像** - 归档至独立硬盘/云端
* ✅ **处理输出** - 保留校准图像及指数
* ✅ **项目文件** - 包含所有设置参数（需重新处理时使用）
* ✅ **调试日志** - 记录处理细节
* ✅ **校准目标图像** - 用于验证与重新处理
...
5. ✅ **启动处理** - 参见[启动处理](starting-the-processing.md)
6. ✅ **监控进度** - 参见[监控处理](monitoring-the-processing.md)
7. ✅ **结果审核** - 本页面
...
* [**多光谱指数公式**](../project-settings/multispectral-index-formulas.md) - 完整指数参考

...
**推荐查看器：*** **QGIS** - 免费GIS软件（最适合地理参考多光谱分析）
...
**预期NDVI数值范围：*** **水体、岩石、土壤**：-0.1至0.2
* **稀疏/不健康植被**：0.2至0.4
* **中等植被**：0.4至0.6
* **健康密集植被**：0.6至0.9**若数值超出上述范围：**
...
**保存内容：*** ✅ **原始RAW/JPG图像** - 存放于独立硬盘/云端
* ✅ **处理输出** - 保留校准图像及指数
* ✅ **项目文件** - 含全部设置参数（需重新处理时使用）
* ✅ **调试日志** - 记录处理细节
* ✅ **校准目标图像** - 用于验证与重新处理**存储建议：*** **即时备份**：外置硬盘
...
2. ✅ **添加文件** - 参见[文件导入](adding-files-to-a-project.md)
...
7. ✅ **结果审核** - 本页面**您已校准且反射率修正的多光谱图像现已准备就绪，可进行分析！**

...
5. ✅ **启动处理** - 详见[启动处理](starting-the-processing.md)
6. ✅ **监控进度** - 详见[监控处理](monitoring-the-processing.md)
7. ✅ **结果审核** - 本页面

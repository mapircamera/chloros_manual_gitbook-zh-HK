...
在处理图像前，需根据工作流程需求配置项目设置。项目设置面板提供对校准、处理选项、多光谱指数及导出格式的全面控制。 <img src="../.gitbook/assets/icon_project-settings.JPG" alt="" data-size="line"> 面板提供全面控制，涵盖校准参数、处理选项、多光谱指数及导出格式设置。
...
* **反射率校准**：使用校准目标归一化数值 ✅ 推荐启用
* **去拜耳算法**：将RAW数据转换为三通道多光谱的算法

...
在处理图像前，需根据工作流程需求配置项目设置。项目设置面板提供对校准、处理选项、多光谱指数及导出格式的全面控制。 <img src="../.gitbook/assets/icon_project-settings.JPG" alt="" data-size="line"> 面板提供全面控制权限，涵盖校准参数、处理选项、多光谱指数及导出格式设置。

...
首次启动 Chloros 和 Chloros（浏览器）时，将启动其后台程序。准备就绪后，左上角的主菜单图标将显示出来 <img src=".gitbook/assets/image (1) (1) (1).png" alt="" data-size="line"> .
...
添加/移除项目中的文件/文件夹。重复文件将被忽略。勾选目标列中的图像，处理程序仅针对已选目标图像执行操作，可大幅提升处理效率。通过图像/元数据切换按钮，可在选定图像的缩略图网格与详细元数据表格视图间切换。

...
- ✅ 代码块与内联代码
- ✅ 数学公式
- ✅ 技术色号（Red, Green, Blue, NIR, RedEdge）
- ✅ 文件路径与URL
- ✅ GitBook 短代码
- ✅ 电子邮件地址
- ✅ 文件扩展名
...
### 仓库结构
- **英文：** `chloros_manual_gitbook`
- **翻译：** `chloros_manual_gitbook-{lang_code}`
...
2. DeepL支持后重新翻译
3. 通过`update_all_translations.py`定期更新
...
- `TRANSLATION_COMMANDS.md` - 命令参考手册
